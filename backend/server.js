...
const metaWhatsappRoutes = require('./routes/metaWhatsapp');
...
app.use('/api/meta-whatsapp', metaWhatsappRoutes);
...
app.listen(PORT, () => {
  ...
  try {
    ...
    console.log('🧹 Notification cleanup service initialized');
  } catch (error) {
    console.error('❌ Failed to initialize notification cleanup:', error);
  }
});
